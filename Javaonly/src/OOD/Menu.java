 ...
 */
public class Menu {
	public String cate; //선택한 카테고리 
	public String storeName; //가게 이름
	public int price; //총 가격
	public String[] menuList; //가게의 메뉴리스트
	public String total[] = new String[100]; // 주문한 리스트
	public Scanner scan = new Scanner(System.in);
	
	public int menuCount; //메뉴의 개수
	
	/*
	 * 가게 입력받기, delivery에 getName 있음.
	 */
	...
	public int scannerException(int m){
		...
		while(true){
			try{
				n = scan.nextInt();
				if(n > m) throw new Exception(); //메뉴 선택 번호 exception
				break;
			}
